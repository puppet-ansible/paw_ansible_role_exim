# paw_ansible_role_exim
# @summary Manage paw_ansible_role_exim configuration
#
# @param exim_dc_eximconfig_configtype other options.
# @param exim_dc_localdelivery Other exim directives.
# @param exim_primary_hostname Set a primary_hostname. If empty, the directive will be ignored.
...
class paw_ansible_role_exim (
  String $exim_dc_eximconfig_configtype = 'internet',
  String $exim_dc_localdelivery = 'mail_spool',
  Optional[String] $exim_primary_hostname = undef,
...
$playbook_path = "${_par_vardir}/lib/puppet_x/ansible_modules/ansible_role_exim/playbook.yml"

par { 'paw_ansible_role_exim-main':
  ensure        => present,
  playbook      => $playbook_path,
  playbook_vars => {
        'exim_dc_eximconfig_configtype' => $exim_dc_eximconfig_configtype,
        'exim_dc_localdelivery' => $exim_dc_localdelivery,
